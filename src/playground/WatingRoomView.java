...
class WaitingRoomView extends JFrame implements ActionListener{
   ...
   /**게임 설명*/
   JLabel gameDes = new JLabel("당신은 전남대 내에 갇혔습니다. 자기장을 피해 AI를 제거하세요. ");
   JLabel gameDes2= new JLabel(	"AI를 모두 제거하거나 죽지 않으면 게임은 끝나지 않습니다.");
   ...
   public WaitingRoomView(UserInfo user, StatusManager player) {
      ...
      gameDes.setBounds(40, 150, 450, 40);
      gameDes2.setBounds(40, 250, 450, 40);
